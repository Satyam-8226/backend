...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    if(!avatar.url) {
        throw new ApiError(400, "Error while uploading avatar image, please try again");
    }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if(!coverImage.url) {
        throw new ApiError(400, "Error while uploading cover image, please try again");
    }
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    if(!channel || channel.length === 0) {
        throw new ApiError(404, "Channel not found with the given username");
    }
